...
public class ArrayListMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Результат для цвета " + color13 + ": " + colorsList2.contains(color13));
        System.out.println("Результат для цвета " + color14 + ": " + colorsList2.contains(color14));
        System.out.println();
        ...
        System.out.println("Заменяемый элемент: " + colorsList3.set(index2, color15));
        ...
        System.out.println("Индекс элемента " + color16 + ": " + colorsList2.indexOf(color16));
        System.out.println();

        System.out.println("11. Получение индекса последнего нахождения элемента ArrayList:");
        int index3 = 9;

        colorsList3.set(index3, color16);
        System.out.println("ArrayList: " + toString(colorsList3));
        System.out.println("Последний индекс элемента " + color16 + ": " + colorsList3.lastIndexOf(color16));
        System.out.println();
        ...
        colorsList2.add(index4, color17);
        printResult(colorsList2, true);
        ...
        colorsList2.add(index5, color18);
        printResult(colorsList2, true);
        ...
        colorsList2.add(index6, color19);
        printResult(colorsList2, true);
        ...
        colorsList2.add(index7, color20);
        printResult(colorsList2, true);
        ...
        colorsList5.add(color25);
        colorsList5.add(color26);
        ...
        colorsList6.add(color27);
        colorsList6.add(color28);
        ...
        colorsList7.add(color29);
        colorsList7.add(color30);
        ...
        colorsList8.add(color31);
        colorsList8.add(color32);
        ...
        colorsList9.add(color33);
        colorsList9.add(color34);
        ...
        colorsList10.add(color35);
        colorsList10.add(color36);
        ...
        colorsList11.add(color37);
        colorsList11.add(color38);
        colorsList11.add(color39);
        colorsList11.add(color40);
        colorsList11.add(color41);
        ...
        colorsList12.add(color42);
        colorsList12.add(color43);
